...
class Austrailia extends StatelessWidget {
  @override
                  ...
                  return Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(
                          snapshot.data['festival 1'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 20),
                        Text(
                          snapshot.data['festival 2'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 20),
                        Text(
                          snapshot.data['festival 3'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 20),
                        Text(
                          snapshot.data['festival 4'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 20),
                        Text(
                          snapshot.data['festival 5'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 20),
                        Text(
                          snapshot.data['festival 6'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 20),
                        Text(
                          snapshot.data['festival 7'],
                          style: TextStyle(fontSize: 20),
                        ),
                        SizedBox(height: 30),
                        Text(
